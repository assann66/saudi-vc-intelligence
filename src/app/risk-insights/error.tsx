...
export default function RiskInsightsError({
  error,
  reset,
}: {
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-8">
      <div className="glass rounded-2xl p-10 max-w-lg w-full text-center space-y-6 animate-fade-in">
        ...
        <div>
          <h2 className="text-2xl font-bold text-white mb-2">تعذّر تحميل تحليل المخاطر</h2>
          <p className="text-zinc-400">
            حدث خطأ أثناء جلب بيانات تحليل المخاطر. يرجى المحاولة مرة أخرى.
          </p>
        </div>
        <button
          onClick={reset}
